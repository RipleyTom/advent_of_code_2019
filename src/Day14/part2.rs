...
fn evaluate(fuel_to_produce: i64, reactions: &Vec<(Element, Vec<Element>)>) -> i64 {
    let mut elements_needed: HashMap<String, i64> = HashMap::new();
    elements_needed.insert("FUEL".to_string(), fuel_to_produce);
